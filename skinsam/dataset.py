...
class ResizeAndPad:
    ...
    def __call__(self, image, masks, bboxes):
        ...
        bboxes = self.transform.apply_boxes(bboxes, (original_h, original_w))
...
def load_datasets(cfg, img_size):
    ...
    train = SkinDataset(root_dir=cfg.dataset.train.root_dir,
                        annotation_file=cfg.dataset.train.annotation_file,
                        transform=transform)
    val = SkinDataset(root_dir=cfg.dataset.val.root_dir,
